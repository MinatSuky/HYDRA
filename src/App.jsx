  ...
  return (
    <>
      <div className="PADRE">
        ...
        <div className="Conteiener-SECCION-1 flex mt-44">
          <div className="cont4 w-[50%] flex flex-col justify-center gap-10 ml-20">
            <div>
              <p className="font-bold text-5xl text-white"><span className="text-6xl bg-gradient-to-r from-[#8176AF] to-[#C0B7E8] BG">Dive</span> Into The Depths</p>
              <p className="font-bold text-5xl text-white">Of <span className="text-6xl bg-gradient-to-r from-[#8176AF] to-[#C0B7E8] BG">Virtual Reality</span></p>
            </div>
            <div className="cont5 ">
          ...
          <div className="cont4 w-[50%] flex justify-center relative">
            <img className="margen" src={img2} alt="" width={650} />
            <svg class="absolute -z-10 w-[70%] h-[150%] left-[30%] bottom-[-120px] " xmlns="http://www.w3.org/2000/svg" width="341" height="67"
            ...
            <svg class="absolute -z-10 top-[-300px] w-[70%] h-[180%]" xmlns="http://www.w3.org/2000/svg" width="383" height="846"
            ...
            <svg class="absolute w-[90%] h-[120%] -z-10" xmlns="http://www.w3.org/2000/svg" width="736" height="423"
